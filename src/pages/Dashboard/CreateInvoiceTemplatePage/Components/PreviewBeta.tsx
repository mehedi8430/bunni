...
export default function PreviewBeta({
  ...
  return (
    ...
    >
      ...
      <div className="mx-3 my-4 mb-8 flex flex-wrap justify-between gap-4">
      ...
      {/* Due date */}
      <div className="mx-3 my-4 mb-6 rounded-full bg-gray-100 py-2.5">
      ...
      <div className="mx-3 my-4 mb-8 flex flex-wrap justify-between gap-4">
        <div className="flex-1 rounded-xl bg-gray-100 px-4 py-3">
          ...
          <p className="mt-2 mb-6 text-xs">{footerTerms}</p>
        </div>
        <div className="flex-1 rounded-xl bg-gray-100 px-4 py-3">
      ...
      {/* Footer */}
      <div
        className="mx-3 my-4 flex items-center justify-between rounded-full bg-gray-100 px-6 py-1"
        // style={{ backgroundColor: color || "#38988A", color: "#fff" }}
      >
        <div className="w-1/3">
          <img
        ...
        <div className="flex w-2/3 items-center justify-end gap-3">
          ...
          <div className="h-[16px] w-0.5 bg-gray-300"></div>

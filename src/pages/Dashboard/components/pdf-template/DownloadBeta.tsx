        ...
        <Document style={styles.document}>
            <Page size="A4" style={{...styles.page, color: color}}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={[styles.tableRow, { color: "#fff", width: "180px", marginLeft: "auto", backgroundColor: color }]}>
                        <Text style={[styles.tableCell, { textAlign: "right", fontWeight: "bold", }]}>Total:</Text>
                        <Text style={[styles.tableCell, { fontWeight: "bold" }]}> ${total.toFixed(2)}</Text>
                    </View>
                </View>
